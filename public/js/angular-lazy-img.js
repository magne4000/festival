...
.factory('LazyImgMagic', ['$window', 'lazyImgConfig', 'lazyImgHelpers',
function($window, lazyImgConfig, lazyImgHelpers) {
    'use strict';

    var winDimensions, $win, images, isListening, options, checkImagesT, saveWinOffsetT;
...
.directive('lazyImg', ['LazyImgMagic', function(LazyImgMagic) {
    'use strict';
