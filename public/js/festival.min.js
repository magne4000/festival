...
/*! festival - v1.0.1 - 2015-05-13
* Copyright (c) 2015 Joël Charles; Licensed  */
!function(a){function b(b){if("string"==typeof b.data&&(b.data={keys:b.data}),b.data&&b.data.keys&&"string"==typeof b.data.keys){var c=b.handler,d=b.data.keys.toLowerCase().split(" "),e=["text","password","number","email","url","range","date","month","week","time","datetime","datetime-local","search","color","tel"];b.handler=function(b){if(this===b.target||!(/textarea|select/i.test(b.target.nodeName)||a.inArray(b.target.type,e)>-1)){var f=a.hotkeys.specialKeys[b.keyCode],g=String.fromCharCode(b.which).toLowerCase(),h="",i={};a.each(["alt","ctrl","meta","shift"],function(a,c){b[c+"Key"]&&f!==c&&(h+=c+"+")}),h=h.replace("alt+ctrl+meta+shift","hyper"),f&&(i[h+f]=!0),g&&(i[h+g]=!0,i[h+a.hotkeys.shiftNums[g]]=!0,"shift+"===h&&(i[a.hotkeys.shiftNums[g]]=!0));for(var j=0,k=d.length;k>j;j++)if(i[d[j]])return c.apply(this,arguments)}}}}a.hotkeys={version:"0.8",specialKeys:{8:"backspace",9:"tab",10:"return",13:"return",16:"shift",17:"ctrl",18:"alt",19:"pause",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"insert",46:"del",59:";",61:"=",96:"0",97:"1",98:"2",99:"3",100:"4",101:"5",102:"6",103:"7",104:"8",105:"9",106:"*",107:"+",109:"-",110:".",111:"/",112:"f1",113:"f2",114:"f3",115:"f4",116:"f5",117:"f6",118:"f7",119:"f8",120:"f9",121:"f10",122:"f11",123:"f12",144:"numlock",145:"scroll",173:"-",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'"},shiftNums:{"`":"~",1:"!",2:"@",3:"#",4:"$",5:"%",6:"^",7:"&",8:"*",9:"(",0:")","-":"_","=":"+",";":": ","'":'"',",":"<",".":">","/":"?","\\":"|"}},a.each(["keydown","keyup","keypress"],function(){a.event.special[this]={add:b}})}(this.jQuery),angular.module("festival",["infinite-scroll","angularLazyImg"]).config(["lazyImgConfigProvider","$locationProvider",function(a,b){var c=document.getElementById("container");a.setOptions({container:angular.element(c)}),b.html5Mode({enabled:!0,requireBase:!1}).hashPrefix("!")}]).factory("$tracks",["$rootScope",function(a){function b(){clearTimeout(m),m=setTimeout(function(){a.$emit("tracks")},100)}function c(){return k}function d(){return l}function e(){k=null,l=null,b()}function f(a){return a=angular.copy(a),a.prev=null,a.next=null,null===k&&(k=a),null!==l&&(a.prev=l,l.next=a),l=a,b(),a}function g(a,c){var d=k;null!==a.prev?a.prev.next=a.next:k=a.next,null!==a.next&&(a.next.prev=a.prev),c?(a.prev=c,a.next=c.next,null!==c.next?c.next.prev=a:l=a,c.next=a):(d.prev=a,a.prev=null,a.next=d,k=a),b()}function h(a){null!==a.next?a.next.prev=a.prev:l=a.prev,null!==a.prev?a.prev.next=a.next:k=a.next,b()}function i(a){if(a=parseInt(a,10),0>a&&(a=0),0===a)return k;for(var b=1,c=k;null!==c.next&&a>=b;)b+=1,c=c.next;return c}function j(){if(null===k)return 0;for(var a=1,b=k;null!==b.next;)a+=1,b=b.next;return a}var k=null,l=null,m=null;return{getHead:c,getTail:d,empty:e,add:f,move:g,remove:h,size:j,get:i}}]).factory("$ajax",["$http",function(a){function b(a,b,c){a=a||{};var d={filters:a};return b&&(d.skip=b),c&&(d.limit=c),d}function c(c,d,e){return a.get("ajax/list/artists",{params:b(c,d,e)})}function d(c,d,e){return a.get("ajax/list/albums",{params:b(c,d,e)})}function e(c,d,e){return a.get("ajax/list/albumsbyartists",{params:b(c,d,e)})}function f(c,d){var e=b(c);return"undefined"!=typeof d&&(e.flat=d),a.get("ajax/list/tracks",{params:e})}function g(b,c,d,e,f){d=!!d;var g={term:b,filters:c,skip:e,limit:f,flat:d};return a.get("ajax/list/search",{params:g})}return{artists:c,albums:d,albumsbyartists:e,tracks:f,search:g}}]).factory("$displayMode",[function(){function a(a){return a&&g[a]&&(g[i].limit=a),g[i].limit}function b(){h+=a()}function c(a){return"undefined"!=typeof a&&(h=a),h}function d(a,b){return a&&g[a]&&(i=a,"undefined"!=typeof b&&(l=b),k=!0,c(0)),i}function e(a,b){a&&g[a]&&(g[a].callback=b)}function f(){!j&&k&&(j=!0,g[i].callback(l,h,a(),function(a){j=!1,k=a,b()}))}var g={artists:{limit:50,callback:function(){}},albumsbyartists:{limit:20,callback:function(){}},search:{limit:10,callback:function(){}}},h=0,i="artists",j=!1,k=!0,l={};return{limit:a,skip:c,current:d,setCallback:e,call:f}}]).factory("$utils",[function(){function a(a,b,c){var d,e,f,g=0,h=a.length-1;for("string"!=typeof c&&(c="Unknown"),c=c.toLowerCase();h>=g;)if(d=(g+h)/2|0,e=a[d][b],"string"!=typeof e&&(e="Unknown"),e=e.toLowerCase(),f=c.localeCompare(e),f>0)g=d+1;else{if(!(0>f))return d;h=d-1}return-1}function b(b,c){var d,e,f,g;for(d=0;d<c.length;d++)if(f=a(b,"artist",c[d].artist),-1===f)b.push(c[d]);else if(c[d].albums)for(e=0;e<c[d].albums.length;e++)g=a(b[f].albums,"name",c[d].albums[e].name),-1===g?b[f].albums.push(c[d].albums[e]):c[d].albums[e].tracks&&Array.prototype.push.apply(b[f].albums[g].tracks,c[d].albums[e].tracks)}return{extend:b}}]).run([function(){}]);var mod;mod=angular.module("infinite-scroll",[]),mod.value("THROTTLE_MILLISECONDS",null),mod.directive("infiniteScroll",["$rootScope","$window","$interval","THROTTLE_MILLISECONDS",function(a,b,c,d){return{scope:{infiniteScroll:"&",infiniteScrollContainer:"=",infiniteScrollDistance:"=",infiniteScrollDisabled:"=",infiniteScrollUseDocumentBottom:"=",infiniteScrollListenForEvent:"@"},link:function(e,f,g){var h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y;return y=angular.element(b),t=null,u=null,i=null,j=null,q=!0,x=!1,w=null,p=function(a){return a=a[0]||a,isNaN(a.offsetHeight)?a.document.documentElement.clientHeight:a.offsetHeight},r=function(a){return a[0].getBoundingClientRect&&!a.css("none")?a[0].getBoundingClientRect().top+s(a):void 0},s=function(a){return a=a[0]||a,isNaN(window.pageYOffset)?a.document.documentElement.scrollTop:a.ownerDocument.defaultView.pageYOffset},o=function(){var b,c,d,g,h;return j===y?(b=p(j)+s(j[0].document.documentElement),d=r(f)+p(f)):(b=p(j),c=0,void 0!==r(j)&&(c=r(j)),d=r(f)-c+p(f)),x&&(d=p((f[0].ownerDocument||f[0].document).documentElement)),g=d-b,h=g<=p(j)*t+1,h?(i=!0,u?e.$$phase||a.$$phase?e.infiniteScroll():e.$apply(e.infiniteScroll):void 0):i=!1},v=function(a,b){var d,e,f;return f=null,e=0,d=function(){var b;return e=(new Date).getTime(),c.cancel(f),f=null,a.call(),b=null},function(){var g,h;return g=(new Date).getTime(),h=b-(g-e),0>=h?(clearTimeout(f),c.cancel(f),f=null,e=g,a.call()):f?void 0:f=c(d,h,1)}},null!=d&&(o=v(o,d)),e.$on("$destroy",function(){return j.unbind("scroll",o),null!=w?(w(),w=null):void 0}),m=function(a){return t=parseFloat(a)||0},e.$watch("infiniteScrollDistance",m),m(e.infiniteScrollDistance),l=function(a){return u=!a,u&&i?(i=!1,o()):void 0},e.$watch("infiniteScrollDisabled",l),l(e.infiniteScrollDisabled),n=function(a){return x=a},e.$watch("infiniteScrollUseDocumentBottom",n),n(e.infiniteScrollUseDocumentBottom),h=function(a){return null!=j&&j.unbind("scroll",o),j=a,null!=a?j.bind("scroll",o):void 0},h(y),e.infiniteScrollListenForEvent&&(w=a.$on(e.infiniteScrollListenForEvent,o)),k=function(a){if(null!=a&&0!==a.length){if(a instanceof HTMLElement?a=angular.element(a):"function"==typeof a.append?a=angular.element(a[a.length-1]):"string"==typeof a&&(a=angular.element(document.querySelector(a))),null!=a)return h(a);throw new Exception("invalid infinite-scroll-container attribute.")}},e.$watch("infiniteScrollContainer",k),k(e.infiniteScrollContainer||[]),null!=g.infiniteScrollParent&&h(angular.element(f.parent())),null!=g.infiniteScrollImmediateCheck&&(q=e.$eval(g.infiniteScrollImmediateCheck)),c(function(){return q?o():void 0},0,1)}}}]),angular.module("angularLazyImg",[]).factory("LazyImgMagic",["$window","lazyImgConfig","lazyImgHelpers",function(a,b,c){"use strict";function d(){for(var a=0;a<n.length;a++){var b=n[a];c.isElementInView(b.$elem[0],p.offset,l)&&(i(b),h(a),a--)}0===n.length&&g()}function e(a){(p.container||m)[a]("scroll",q),(p.container||m)[a]("touchmove",q),m[a]("resize",q),m[a]("resize",r)}function f(){o=!0,setTimeout(function(){d(),e("on")},1)}function g(){o=!1,e("off")}function h(a){n.splice(a,1)}function i(a){var b=new Image;b.onerror=function(){p.errorClass&&a.$elem.addClass(p.errorClass),p.onError(a)},b.onload=function(){j(a.$elem,a.src),p.successClass&&a.$elem.addClass(p.successClass),p.onSuccess(a)},b.src=a.src}function j(a,b){"img"===a[0].nodeName.toLowerCase()?a[0].src=b:a.css("background-image",'url("'+b+'")')}function k(a){this.$elem=a}var l,m,n,o,p,q,r;return n=[],o=!1,p=b.getOptions(),m=angular.element(a),l=c.getWinDimensions(),r=c.throttle(function(){l=c.getWinDimensions()},60),q=c.throttle(d,30),k.prototype.setSource=function(a){this.src=a,n.push(this),o||f()},k.prototype.removeImage=function(){var a=n.indexOf(this);h(a),0===n.length&&g()},k}]).provider("lazyImgConfig",function(){"use strict";this.options={offset:100,errorClass:null,successClass:null,onError:function(){},onSuccess:function(){}},this.$get=function(){var a=this.options;return{getOptions:function(){return a}}},this.setOptions=function(a){angular.extend(this.options,a)}}).factory("lazyImgHelpers",["$window",function(a){"use strict";function b(){return{height:a.innerHeight,width:a.innerWidth}}function c(a,b,c){var d=a.getBoundingClientRect(),e=c.height+b;return d.left>=0&&d.right<=c.width+b&&(d.top>=0&&d.top<=e||d.bottom<=e&&d.bottom>=0-b)}function d(a,b,c){var d,e;return function(){var f=c||this,g=+new Date,h=arguments;d&&d+b>g?(clearTimeout(e),e=setTimeout(function(){d=g,a.apply(f,h)},b)):(d=g,a.apply(f,h))}}return{isElementInView:c,getWinDimensions:b,throttle:d}}]).directive("lazyImg",["LazyImgMagic",function(a){"use strict";function b(b,c,d){var e=new a(c);e.setSource(d.lazyImg),b.$on("$destroy",function(){e.removeImage()})}return{link:b,restrict:"A"}}]),angular.module("festival").directive("ngProgress",[function(){return{scope:{ngProgress:"=",ngProgressDuration:"="},require:"?ngProgressDuration",link:function(a,b,c){function d(a,c){var d=a/c*100;d>100&&(d=100),b.width(d+"%")}a.$watch("ngProgress",function(c,e){c&&a.ngProgressDuration?d(c,a.ngProgressDuration):b.width(0)}),a.$watch("ngProgressDuration",function(c,e){c&&a.ngProgress?d(a.ngProgress,c):b.width(0)})}}}]).directive("ngLoading",[function(){return{scope:{ngLoading:"=",ngLoadingDuration:"="},require:"?ngLoadingDuration",link:function(a,b,c){function d(a,c){var d=(a.end-a.start)/(10*c);d>100&&(d=100),b.width(d+"%")}function e(a,c){var d=a.start/c*100;b.css("left",d+"%")}a.$watch("ngLoading",function(c,f){c&&a.ngLoadingDuration?(d(c,a.ngLoadingDuration),e(c,a.ngLoadingDuration)):(b.width(0),b.css("left",0))}),a.$watch("ngLoadingDuration",function(c,f){c&&a.ngLoading?(d(a.ngLoading,c),e(a.ngLoading,c)):(b.width(0),b.css("left",0))})}}}]),angular.module("festival").filter("duration",function(){return function(a){a=Math.floor(a);var b=Math.max(0,Math.floor(a/60));return a%=60,[("0"+b).slice(-2),("0"+a).slice(-2)].join(":")}}),angular.module("festival").controller("PlayerController",["$scope","$tracks","$timeout",function(a,b,c){function d(c){if(a.currentTrack){if(!c&&2===a.loop)return a.currentTrack;if(a.shuffle){if(0===i.length){if(1!==a.loop)return null;i=h,h=[]}if(i.length>0){var d=Math.floor(Math.random()*i.length),e=i[d];return h.push(e),i.splice(d,1),j=e,b.get(e)}}return a.currentTrack.next||1!==a.loop?a.currentTrack.next:b.getHead()}return null}function e(){return a.currentTrack?a.shuffle?0===h.length?null:(i.push(h.pop()),j=i[i.length-1],b.get(j)):null===a.currentTrack.prev&&1===a.loop?b.getTail():a.currentTrack.prev:null}function f(){a.currentSound&&(a.currentSound.unload(),a.currentSound.stop())}function g(){a.currentSound&&a.currentSound.play()}var h=[],i=[],j=0,k=null,l=0,m=100,n=!1;a.currentTrack=null,a.currentSound=null,a.shuffle=!1,a.loop=0,a.buffered=0,a.duration=0,a.playing=!1,a.volumeval=100,a.showind=function(){return arguments[arguments[0]+1]},a.play=function(b,c){f(),b?c?a.add(c,!0,b._id):a.load(b,!0):g()},a.next=function(b,c){var e=d(c);f(),e&&a.load(e,b)},a.prev=function(b){var c=e();f(),c&&a.load(c,b)},a.add=function(c,d,e){if(!n){n=!0;var f=[],g=0,h=b.size(),j=h,k=null;c._id?f.push(c):f=c,a.shuffle&&(k=Math.floor(Math.random()*f.length));for(g in f){i.push(i.length);var l=b.add(f[g]);e===f[g]._id?a.load(l,d):0!==h||a.shuffle?k===h&&0===j&&a.shuffle&&a.load(l,d):a.load(l,d),h++}n=!1}},a.remove=function(a){a&&b.remove(a)},a.load=function(b,c){b&&(clearTimeout(k),k=setTimeout(function(){a.currentTrack=b,c&&f();var d="t_"+b._id;a.currentSound=soundManager.getSoundById(d),a.currentSound?c&&a.currentSound.play():a.currentSound=soundManager.createSound({id:d,url:b.url,type:b.mime,autoLoad:!0,autoPlay:!!c,whileplaying:function(){var b=this;a.$apply(function(){l=b.position/1e3})},whileloading:function(){var b=this;a.$apply(function(){a.duration=Math.floor(b.durationEstimate/1e3),a.buffered=b.buffered})},onfinish:function(){a.$apply(function(){l=0,a.playing=!1,a.next(!0)})},onstop:function(){a.$apply(function(){l=0,a.playing=!1})},onpause:function(){a.$apply(function(){a.playing=!1})},onplay:function(){a.$apply(function(){a.playing=!0})},onload:function(c){var d=this;a.$apply(c?function(){b.failed&&(b.failed=!1),a.duration=Math.floor(d.duration/1e3),a.buffered=d.buffered}:function(){b.failed=!0,l=0,a.playing=!1,a.next(!0)})},onresume:function(){a.$apply(function(){a.playing=!0})},volume:a.volume()||100})},10))},a.togglePlayPause=function(){c(function(){a.currentSound&&a.currentSound.togglePause()},0)},a.playOrPause=function(b,d){c(function(){console.log(b),!b||a.currentTrack&&a.currentTrack._id===b._id?a.currentSound.togglePause():(d&&a.empty(),a.play(b,d))},0)},a.toggleShuffle=function(){a.shuffle=!a.shuffle,h=[]},a.circleLoop=function(){a.loop=(a.loop+1)%3},a.empty=function(){h=[],i=[],j=0,b.empty()},a.progress=function(b){return b&&a.currentSound&&c(function(){a.currentSound.setPosition(1e3*b)},0),l},a.volume=function(b){return"string"==typeof b&&(b=parseInt(b,10)),"number"==typeof b&&(a.volumeval=b,a.currentSound&&c(function(){a.currentSound.setVolume(b)},0)),a.volumeval},a.toggleVolume=function(){0===a.volumeval?a.volume(m):(m=a.volumeval,a.volume(0))},$(document).on("keydown",null,"space",function(b){b.preventDefault(),a.togglePlayPause()}),$(document).on("keydown",null,"left",function(b){b.preventDefault(),a.prev(a.playing)}),$(document).on("keydown",null,"right",function(b){b.preventDefault(),a.next(a.playing)})}]).controller("ListController",["$scope","$rootScope","$ajax","$displayMode","$utils","$timeout",function(a,b,c,d,e,f){function g(a,d,f,g){b.loading=!0,c.artists(a,d,f).success(function(a,c){b.loading=!1,g(a.length>0),e.extend(b.artists,a)}).error(function(){b.loading=!1,g(!1)})}function h(a,d,f,g){b.loading=!0,c.albumsbyartists(a,d,f).success(function(a,c){b.loading=!1,g(a.length>0),e.extend(b.artists,a)}).error(function(){b.loading=!1,g(!1)})}b.artists=[],b.loading=!1,d.setCallback("artists",g),d.setCallback("albumsbyartists",h),d.current("artists",{}),a.pageArtists=function(){d.call()},a.loadAlbums=function(a){if(a.albums&&a.albums.length>0)return void(a.expanded=!a.expanded);var b={artist:a.artist};c.albumsbyartists(b).success(function(b,c){b.length>0?(a.expanded=!0,a.albums=b[0].albums):a.expanded=!1})},a.loadAlbumsAndTracks=function(a,b){if(a.everythingLoaded)a.expanded=!a.expanded,f(function(){b(a)},0);else{var d={artist:a.artist};c.tracks(d,!1).success(function(c,d){a.albums=c[0].albums,a.expanded=a.albums.length>0,a.everythingLoaded=!0,"function"==typeof b&&b(a)})}},a.loadAlbumsAndTracksAndAdd=function(b,c){a.loadAlbumsAndTracks(b,function(d){if(d.albums){d.expanded=b.albums.length>0;for(var e=0;e<d.albums.length;e++)a.add(d.albums[e].tracks,c),c=!1}})},a.loadTracks=function(a,b,d){if(b.tracks&&b.tracks.length>0)"function"==typeof d&&f(function(){d(a,b)},0);else{var e={artist:a.artist,album:b.name};c.tracks(e,!0).success(function(c,e){b.tracks=c,"function"==typeof d&&d(a,b)})}},a.loadTracksAndAdd=function(b,c,d){a.loadTracks(b,c,function(b,c){a.add(c.tracks,d)})},a.toggleTracks=function(b,c){"undefined"==typeof c.trackshidden?(c.trackshidden=c.tracks&&c.tracks.length>0,a.loadTracks(b,c)):c.trackshidden=!c.trackshidden}}]).controller("QueueController",["$scope","$rootScope","$tracks",function(a,b,c){function d(){a.$apply(function(){var b=c.getHead(),d=b;if(a.tracks=[],d)for(a.tracks.push(d);d.next;)a.tracks.push(d.next),d=d.next})}a.tracks=[],a.show=!1,b.$on("tracks",d)}]).controller("ToolbarController",["$scope","$rootScope","$ajax","$displayMode","$utils","$timeout","$location",function(a,b,c,d,e,f,g){function h(d,f,g,h){b.loading=!0,c.search(d,a.checkboxFilter,!1,f,g).success(function(a,c){b.loading=!1,h(a.length>0);for(var d=0;d<a.length;d++)a[d].expanded=!0;e.extend(b.artists,a)}).error(function(){b.loading=!1,h(!1)})}a.value="",a.checkboxFilter={artists:!0,albums:!0,tracks:!0};var i=null,j="";d.setCallback("search",h),a.$watch("checkboxFilter",function(b,c){angular.equals(b,c)||(g.search("sar",b.artists),g.search("sal",b.albums),g.search("str",b.tracks),f.cancel(i),i=f(a.searchnow,700))},!0),a.search=function(){j!==a.value&&(j=a.value,f.cancel(i),i=f(a.searchnow,400))},a.searchnow=function(){b.artists=[],a.value.length>0?d.current("search",a.value):d.current("artists",{}),g.search("s",a.value),d.call()};var k=a.$on("$locationChangeSuccess",function(){k();var b=!0,c=g.search();"undefined"!=typeof c.sar&&(c.sar=c.sar===!0,a.checkboxFilter.artists!==c.sar&&(b=!1),a.checkboxFilter.artists=c.sar),"undefined"!=typeof c.sal&&(c.sal=c.sal===!0,a.checkboxFilter.albums!==c.sal&&(b=!1),a.checkboxFilter.albums=c.sal),"undefined"!=typeof c.str&&(c.str=c.str===!0,a.checkboxFilter.tracks!==c.str&&(b=!1),a.checkboxFilter.tracks=c.str),"undefined"!=typeof c.s&&(a.value=c.s),b&&a.searchnow()})}]);