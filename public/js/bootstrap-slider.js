	...
	Slider.prototype = {
		...
		layout: function(){
			...
			if (this.range) {
				...
				if (this.orientation === 'vertical') {
                    this.tooltip[0].style[this.stylePos] = this.selectionElStyle.top;
				} else {
                    this.tooltip[0].style[this.stylePos] = this.selectionElStyle.width;
				}
			}
		},
